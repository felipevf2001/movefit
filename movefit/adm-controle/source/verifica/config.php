<script>
  alert('Site no Ar');
  window.location.href = "https://www.guerreiroimplementos.com.br/";
</script>
<?php
die();
error_reporting(1);
...
// // ===================== | CONEXÃO COM BD | ====================== \\
$host  = "162.241.2.55";
$banco = "guerre92_esl_2023";//banco e user mesmo
$user  = "guerre92_esl";
$senha = "3H6B10@8r5v2";
...
define('HOST','https://www.g8sites.com.br/2023/guerreiro/');
...
function configura_url($pagina = "home", $url_ramo = null){

  global $banco;

  $url_correta = $banco->query('select * from pagina where id_idioma = "'.$url_ramo['id_idioma'].'" and url_sem_extencao = "'.$pagina.'"')->fetch();

  return HOST.$url_ramo['url_configuravel']."/".$url_correta['url_configuravel'];
